...
.btn {
  @apply z-0 inline-flex items-center px-6 py-2 text-base font-medium focus:outline-none focus:ring-1 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed active:hover:scale-95 transition ease-in-out duration-150 active:hover:z-50 focus:z-50;
}
